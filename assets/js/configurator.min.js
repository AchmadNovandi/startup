...
function ColorOptions() {
    function o(o, e) {
        i.attr("href", a + "style." + o + "-" + e + ".min.css"), n.removeClass("active"), r.removeClass("active"), n = $("#color-options .ms-color-box-primary." + o), r = $("#grad-options .grad.c" + e), n.addClass("active"), r.addClass("active"), $.cookie("ms-color", o, {
            expires: 7,
            path: "/"
        }), $.cookie("ms-shine", e, {
            expires: 7,
    ...
    var e = urlofdoc("app.min.js"),
        ...
        s = "light-blue",
        c = 500;
    $.cookie("ms-color") && ($(".grad").removeClass(s), s = $.cookie("ms-color"), $.cookie("ms-shine") && (c = $.cookie("ms-shine")), o(s, c), $(".grad").addClass(s)), $("#color-options .ms-color-box-primary").click(function() {
        return $(".grad").removeClass(s), s = $(this).data("color"), $(".grad").addClass(s), o(s, 500), !1
    }), $("#grad-options .grad").click(function() {
        return c = $(this).data("shine"), o(s, c), !1
    })
}

function urlofdoc(o) {
    var e, a;
    return e = $("script[src*='app.min.js']").attr("src"), e.indexOf(o) >= 0 && (a = e.substring(0, e.indexOf(o) - 3)), a
}
